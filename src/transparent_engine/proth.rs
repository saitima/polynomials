...
// 0800 0000 0000 0011
const _K: u64 = 576460752303423505u64;

const _K_U128: u128 = 576460752303423505u128;
...
impl pairing::ff::PrimeFieldRepr for FrRepr {
    #[inline(always)]
    fn is_odd(&self) -> bool {
        self.0[0] & 1 == 1
    }
    ...
    fn add_nocarry(&mut self, other: &FrRepr) {
        ...
        for (a, b) in self.0.iter_mut().zip(other.0.iter()) {
            *a = pairing::ff::adc(*a, *b, &mut carry);
        }
    }
    #[inline(always)]
    fn sub_noborrow(&mut self, other: &FrRepr) {
        let mut borrow = 0;
        for (a, b) in self.0.iter_mut().zip(other.0.iter()) {
            *a = pairing::ff::sbb(*a, *b, &mut borrow);
        }
    }
}
...
impl FrRepr {
    ...
    fn add_modulus_nocarry(&mut self) {
        ...
        self.0[3] = pairing::ff::adc(self.0[3], MODULUS.0[3usize], &mut carry);
    }
    ...
    fn sub_modulus_noborrow(&mut self) {
        ...
        self.0[3] = pairing::ff::sbb(self.0[3], MODULUS.0[3usize], &mut borrow);
    }
    ...
    fn add_modulus_twice_nocarry(&mut self) {
        ...
        self.0[3] = pairing::ff::adc(self.0[3], MODULUS_TWICE.0[3usize], &mut carry);
    }
    ...
    fn sub_modulus_twice_noborrow(&mut self) {
        ...
        self.0[3] = pairing::ff::sbb(self.0[3], MODULUS_TWICE.0[3usize], &mut borrow);
    }
}
...
impl pairing::ff::PrimeField for Fr {
    type Repr = FrRepr;

    fn from_repr(r: FrRepr) -> Result<Fr, pairing::ff::PrimeFieldDecodingError> {
        let mut r = Fr(r);
        if r.is_valid() {
            r.mul_assign(&Fr(R2));
            Ok(r)
        } else {
            Err(pairing::ff::PrimeFieldDecodingError::NotInField(format!("{}", r.0)))
        }
    }

    fn from_raw_repr(r: FrRepr) -> Result<Self, pairing::ff::PrimeFieldDecodingError> {
        let r = Fr(r);
        if r.is_valid() {
            Ok(r)
        } else {
...
impl pairing::ff::Field for Fr {
    ...
    fn mul_assign(&mut self, other: &Fr) {
        let mut carry = 0;
        let r0 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (other.0).0[0usize], &mut carry);
        let r1 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (other.0).0[1usize], &mut carry);
        let r2 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (other.0).0[2usize], &mut carry);
        let r3 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (other.0).0[3usize], &mut carry);
        let r4 = carry;
        let mut carry = 0;
        let r1 =
            pairing::ff::mac_with_carry(r1, (self.0).0[1usize], (other.0).0[0usize], &mut carry);
        let r2 =
            pairing::ff::mac_with_carry(r2, (self.0).0[1usize], (other.0).0[1usize], &mut carry);
        let r3 =
            pairing::ff::mac_with_carry(r3, (self.0).0[1usize], (other.0).0[2usize], &mut carry);
        let r4 =
            pairing::ff::mac_with_carry(r4, (self.0).0[1usize], (other.0).0[3usize], &mut carry);
        let r5 = carry;
        let mut carry = 0;
        let r2 =
            pairing::ff::mac_with_carry(r2, (self.0).0[2usize], (other.0).0[0usize], &mut carry);
        let r3 =
            pairing::ff::mac_with_carry(r3, (self.0).0[2usize], (other.0).0[1usize], &mut carry);
        let r4 =
            pairing::ff::mac_with_carry(r4, (self.0).0[2usize], (other.0).0[2usize], &mut carry);
        let r5 =
            pairing::ff::mac_with_carry(r5, (self.0).0[2usize], (other.0).0[3usize], &mut carry);
        let r6 = carry;
        let mut carry = 0;
        let r3 =
            pairing::ff::mac_with_carry(r3, (self.0).0[3usize], (other.0).0[0usize], &mut carry);
        let r4 =
            pairing::ff::mac_with_carry(r4, (self.0).0[3usize], (other.0).0[1usize], &mut carry);
        let r5 =
            pairing::ff::mac_with_carry(r5, (self.0).0[3usize], (other.0).0[2usize], &mut carry);
        let r6 =
            pairing::ff::mac_with_carry(r6, (self.0).0[3usize], (other.0).0[3usize], &mut carry);
        let r7 = carry;
    ...
    fn square(&mut self) {
        let mut carry = 0;
        let r1 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (self.0).0[1usize], &mut carry);
        let r2 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (self.0).0[2usize], &mut carry);
        let r3 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (self.0).0[3usize], &mut carry);
        let r4 = carry;
        let mut carry = 0;
        let r3 =
            pairing::ff::mac_with_carry(r3, (self.0).0[1usize], (self.0).0[2usize], &mut carry);
        let r4 =
            pairing::ff::mac_with_carry(r4, (self.0).0[1usize], (self.0).0[3usize], &mut carry);
        let r5 = carry;
        let mut carry = 0;
        let r5 =
            pairing::ff::mac_with_carry(r5, (self.0).0[2usize], (self.0).0[3usize], &mut carry);
        let r6 = carry;
        let r7 = r6 >> 63;
        let r6 = (r6 << 1) | (r5 >> 63);
        let r5 = (r5 << 1) | (r4 >> 63);
        ...
        let mut carry = 0;
        let r0 =
            pairing::ff::mac_with_carry(0, (self.0).0[0usize], (self.0).0[0usize], &mut carry);
        let r1 = pairing::ff::adc(r1, 0, &mut carry);
        let r2 =
            pairing::ff::mac_with_carry(r2, (self.0).0[1usize], (self.0).0[1usize], &mut carry);
        let r3 = pairing::ff::adc(r3, 0, &mut carry);
        let r4 =
            pairing::ff::mac_with_carry(r4, (self.0).0[2usize], (self.0).0[2usize], &mut carry);
        let r5 = pairing::ff::adc(r5, 0, &mut carry);
        let r6 =
            pairing::ff::mac_with_carry(r6, (self.0).0[3usize], (self.0).0[3usize], &mut carry);
        let r7 = pairing::ff::adc(r7, 0, &mut carry);
        self.mont_reduce(r0, r1, r2, r3, r4, r5, r6, r7);
    }
}
...
impl Fr {
    ...
    fn mont_reduce_unreduced(
        ...
        let mut carry = 0;
        pairing::ff::adc(r0, k, &mut carry);
        r1 = add_carry(r1, &mut carry);
        r2 = add_carry(r2, &mut carry);
        r3 = pairing::ff::mac_with_carry(r3, k, MODULUS.0[3usize], &mut carry);
        r4 = add_carry(r4, &mut carry);

        let carry2 = carry;
        let k = (!r1).wrapping_add(1);
        let mut carry = 0;
        pairing::ff::adc(r1, k, &mut carry);
        r2 = add_carry(r2, &mut carry);
        r3 = add_carry(r3, &mut carry);
        r4 = pairing::ff::mac_with_carry(r4, k, MODULUS.0[3usize], &mut carry);
        r5 = pairing::ff::adc(r5, carry2, &mut carry);

        let carry2 = carry;
        let k = (!r2).wrapping_add(1);
        let mut carry = 0;
        pairing::ff::adc(r2, k, &mut carry);
        r3 = add_carry(r3, &mut carry);
        r4 = add_carry(r4, &mut carry);
        r5 = pairing::ff::mac_with_carry(r5, k, MODULUS.0[3usize], &mut carry);
        r6 = pairing::ff::adc(r6, carry2, &mut carry);

        let carry2 = carry;
        let k = (!r3).wrapping_add(1);
        let mut carry = 0;
        pairing::ff::adc(r3, k, &mut carry);
        r4 = add_carry(r4, &mut carry);
        r5 = add_carry(r5, &mut carry);
        r6 = pairing::ff::mac_with_carry(r6, k, MODULUS.0[3usize], &mut carry);
        r7 = pairing::ff::adc(r7, carry2, &mut carry);
    ...
    pub fn _to_hex(&self) -> String {
        ...
        pairing::ff::hex::encode(&buf)
    }

    pub fn _from_hex(value: &str) -> Result<Fr, String> {
        ...
        let mut buf = pairing::ff::hex::decode(&value).map_err(|_| format!("could not decode hex: {}", value))?;
        buf.reverse();
        buf.resize(32, 0);
...
impl pairing::ff::SqrtField for Fr {
    fn legendre(&self) -> pairing::ff::LegendreSymbol {
        let s = self.pow([0u64, 0u64, 9223372036854775808u64, 288230376151711752u64]);
        if s == Self::zero() {
            pairing::ff::LegendreSymbol::Zero
        } else if s == Self::one() {
            pairing::ff::LegendreSymbol::QuadraticResidue
        } else {
            pairing::ff::LegendreSymbol::QuadraticNonResidue
        }
    }
    fn sqrt(&self) -> Option<Self> {
        match self.legendre() {
            pairing::ff::LegendreSymbol::Zero => Some(*self),
            pairing::ff::LegendreSymbol::QuadraticNonResidue => None,
            pairing::ff::LegendreSymbol::QuadraticResidue => {
