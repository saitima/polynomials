...
mod test {
    ...
    #[test]
    fn test_proth_field() {
        use pairing::ff::{Field, PrimeField, to_hex};
        use super::Fr as FrMontNaive;
        use super::proth::Fr as FrOptimized;
    ...
    // TODO: depends on crate::plonk::commitments::transparent::precomputations::*;
    // #[test]
    ...
    //     use crate::fft::with_precomputation::FftPrecomputations;
    //     use crate::fft::with_precomputation::fft::best_fft as best_fft_with_precomputations;
    ...
    fn test_bench_ct_ploth_lde() {
        ...
        use std::time::Instant;
        use crate::multicore::*;
        use crate::fft::cooley_tukey_ntt::{CTPrecomputations, BitReversedOmegas};
    ...
    fn test_bench_ct_proth_fft() {
        ...
        use crate::multicore::*;
        use crate::utils::log2_floor;
        use crate::fft::cooley_tukey_ntt::{CTPrecomputations, BitReversedOmegas, best_ct_ntt};
        use crate::fft::fft::best_fft;
        use crate::domains::Domain;
