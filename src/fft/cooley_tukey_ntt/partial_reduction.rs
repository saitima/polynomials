...
pub(crate) fn _best_ct_ntt_partial_reduction<F: PartialTwoBitReductionField, P: CTPrecomputations<F>>(
    a: &mut [F], 
    worker: &Worker, 
    log_n: u32, 
...
mod test {
    ...
    fn test_bench_ct_serial_fft() {
        ...
        use crate::transparent_engine::proth::Fr;
    ...
    fn test_bench_ct_parallel_fft() {
        ...
        use std::time::Instant;
        use super::*;
        use crate::fft::fft::parallel_fft;
        use super::CTPrecomputations;
        use super::super::BitReversedOmegas;
        use crate::domains::Domain;
